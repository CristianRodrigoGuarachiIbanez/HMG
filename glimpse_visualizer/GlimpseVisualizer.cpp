...
#define __PYX_HAVE__visualizer
#define __PYX_HAVE_API__visualizer
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
struct __pyx_t_10visualizer_Points;

/* "GlimpseVisualizer.pyx":12
 * 
 * ctypedef unsigned char uchar
 * cdef struct Points:             # <<<<<<<<<<<<<<
 *     int start
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsdsdsds_nn___pyx_t_10visualizer_uchar(PyObject *, int writable_flag);

/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_10visualizer_uchar(PyObject *, int writable_flag);
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_10visualizer_uchar = { "uchar", NULL, sizeof(__pyx_t_10visualizer_uchar), { 0 }, 0, IS_UNSIGNED(__pyx_t_10visualizer_uchar) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_10visualizer_uchar), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "visualizer"
extern int __pyx_module_is_main_visualizer;
int __pyx_module_is_main_visualizer = 0;

/* Implementation of 'visualizer' */
...
static int __pyx_pw_10visualizer_11GVisualizer_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    __pyx_v_features = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsdsds_nn___pyx_t_10visualizer_uchar(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_features.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_labels = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_10visualizer_uchar(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_labels.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_positions = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_positions.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
  }
 ...
 */
  __pyx_v_self->heat_maps = ((unsigned char ****)malloc(((__pyx_v_labels.shape[2]) * (sizeof(unsigned char ***)))));

  /* "GlimpseVisualizer.pyx":24
 *         self.setFeatureDimensions(features)
 *         self.heat_maps = <unsigned char****>malloc(labels.shape[2]*sizeof(unsigned char***))
 *         self.setOutputDimensions(self.heat_maps, labels, positions)             # <<<<<<<<<<<<<<
 *         self.create_heatmaps(labels, positions)
 ...
 */
  __pyx_t_1 = (((__pyx_v_features.shape[4]) < 0x96) != 0);
  if (__pyx_t_1) {

    /* "GlimpseVisualizer.pyx":32
 *     cdef void setFeatureDimensions(self,uchar[:,:,:,:,:] features ):
 *         if(features.shape[4]<150):
 *             self.dim3 = features.shape[2] # 120             # <<<<<<<<<<<<<<
 *             self.dim4 = features.shape[3] # 160
 *         else:
 */
    __pyx_v_self->dim3 = (__pyx_v_features.shape[2]);

    /* "GlimpseVisualizer.pyx":33
 *         if(features.shape[4]<150):
 *             self.dim3 = features.shape[2] # 120
 *             self.dim4 = features.shape[3] # 160             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_v_self->dim4 = (__pyx_v_features.shape[3]);
 ...
 */
  /*else*/ {
    __pyx_v_self->dim3 = (__pyx_v_features.shape[3]);

    /* "GlimpseVisualizer.pyx":36
 *         else:
 *             self.dim3 = features.shape[3] # 120
 *             self.dim4 = features.shape[4] # 160             # <<<<<<<<<<<<<<
 *     @boundscheck(False)
 *     @wraparound(False)
 */
    __pyx_v_self->dim4 = (__pyx_v_features.shape[4]);
  }
  __pyx_L3:;
 ...
 */
  __pyx_v_self->images = (__pyx_v_labels.shape[0]);

  /* "GlimpseVisualizer.pyx":42
 *     cdef void setOutputDimensions(self, uchar****&features, uchar[:,:,:] labels, double[:,:,:] positions):
 *         self.images = labels.shape[0] #N
 *         self.dim1= labels.shape[2] # 6             # <<<<<<<<<<<<<<
 *         self.dim2 = positions.shape[1] # 11
 ...
 */
  __pyx_v_self->dim1 = (__pyx_v_labels.shape[2]);

  /* "GlimpseVisualizer.pyx":43
 *         self.images = labels.shape[0] #N
 *         self.dim1= labels.shape[2] # 6
 *         self.dim2 = positions.shape[1] # 11             # <<<<<<<<<<<<<<
 *         self.populate_heatmaps(features, self.dim1, self.dim2, self.dim3, self.dim4)
 *     @boundscheck(False)
 */
  __pyx_v_self->dim2 = (__pyx_v_positions.shape[1]);

  /* "GlimpseVisualizer.pyx":44
 *         self.dim1= labels.shape[2] # 6
 *         self.dim2 = positions.shape[1] # 11
 *         self.populate_heatmaps(features, self.dim1, self.dim2, self.dim3, self.dim4)             # <<<<<<<<<<<<<<
 *     @boundscheck(False)
 ...
 */
    (__pyx_v_heat_map[__pyx_v_i]) = ((unsigned char ***)malloc((__pyx_v_dim1 * (sizeof(unsigned char **)))));

    /* "GlimpseVisualizer.pyx":52
 *         for i in range(dim):
 *             heat_map[i] = <unsigned char***>malloc(dim1*sizeof(unsigned char**))
 *             for j in range(dim1):             # <<<<<<<<<<<<<<
 *                 heat_map[i][j] = <uchar**>malloc(rows*sizeof(uchar*))
 *                 for k in range(rows):
 */
    __pyx_t_4 = __pyx_v_dim1;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "GlimpseVisualizer.pyx":53
 *             heat_map[i] = <unsigned char***>malloc(dim1*sizeof(unsigned char**))
 *             for j in range(dim1):
 *                 heat_map[i][j] = <uchar**>malloc(rows*sizeof(uchar*))             # <<<<<<<<<<<<<<
 *                 for k in range(rows):
 ...
 */
      ((__pyx_v_heat_map[__pyx_v_i])[__pyx_v_j]) = ((__pyx_t_10visualizer_uchar **)malloc((__pyx_v_rows * (sizeof(__pyx_t_10visualizer_uchar *)))));

      /* "GlimpseVisualizer.pyx":54
 *             for j in range(dim1):
 *                 heat_map[i][j] = <uchar**>malloc(rows*sizeof(uchar*))
 *                 for k in range(rows):             # <<<<<<<<<<<<<<
 *                     heat_map[i][j][k] = <uchar*>malloc(cols*sizeof(uchar))
 ...
 *     @boundscheck(False)
 */
        (((__pyx_v_heat_map[__pyx_v_i])[__pyx_v_j])[__pyx_v_k]) = ((__pyx_t_10visualizer_uchar *)malloc((__pyx_v_cols * (sizeof(unsigned char)))));
      }
    }
  }

  /* "GlimpseVisualizer.pyx":56
 *                 for k in range(rows):
 *                     heat_map[i][j][k] = <uchar*>malloc(cols*sizeof(uchar))
 *         self.zeros(heat_map, dim, dim1,rows, cols)             # <<<<<<<<<<<<<<
 *     @boundscheck(False)
 ...
 *     @boundscheck(False)
 */
          ((((__pyx_v_heat_map[__pyx_v_i])[__pyx_v_j])[__pyx_v_k])[__pyx_v_n]) = 10;
        }
      }
    }
  }
 ...
 */
  __pyx_t_1 = 0;
  __pyx_v_elem = (*((__pyx_t_10visualizer_uchar *) ( /* dim=0 */ (__pyx_v_elements.data + __pyx_t_1 * __pyx_v_elements.strides[0]) )));

  /* "GlimpseVisualizer.pyx":74
 *         cdef int i, elem, index
 *         elem = elements[0]
 *         index = 0             # <<<<<<<<<<<<<<
 *         for i in range(1,size):
 ...
 */
    __pyx_t_1 = __pyx_v_i;
    __pyx_t_5 = ((__pyx_v_elem < (*((__pyx_t_10visualizer_uchar *) ( /* dim=0 */ (__pyx_v_elements.data + __pyx_t_1 * __pyx_v_elements.strides[0]) )))) != 0);
    if (__pyx_t_5) {

      /* "GlimpseVisualizer.pyx":77
 *         for i in range(1,size):
 *             if(elem<elements[i]):
 *                 elem = elements[i]             # <<<<<<<<<<<<<<
 *                 index = i
 ...
 */
  __pyx_t_1 = __pyx_v_h;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = __pyx_v_y; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "GlimpseVisualizer.pyx":87
 *         cdef int i,j
 *         for i in range(y, h):
 *             for j in range(x, w):             # <<<<<<<<<<<<<<
 *                 heat_maps[index][step][i][j] =255
 ...
 */
    __pyx_t_4 = __pyx_v_w;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = __pyx_v_x; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "GlimpseVisualizer.pyx":88
 *         for i in range(y, h):
 *             for j in range(x, w):
 *                 heat_maps[index][step][i][j] =255             # <<<<<<<<<<<<<<
 * 
 *     @boundscheck(False)
 */
      ((((__pyx_v_heat_maps[__pyx_v_index])[__pyx_v_step])[__pyx_v_i])[__pyx_v_j]) = 0xFF;
    }
  }
...
static CYTHON_INLINE std::pair<struct __pyx_t_10visualizer_Points,struct __pyx_t_10visualizer_Points>  __pyx_f_10visualizer_11GVisualizer_bb_dimensions(CYTHON_UNUSED struct __pyx_obj_10visualizer_GVisualizer *__pyx_v_self, int __pyx_v_x, int __pyx_v_y, int __pyx_v_w, int __pyx_v_h, __Pyx_memviewslice __pyx_v_bb_o, int __pyx_v_clip) {
  ...
  std::pair<struct __pyx_t_10visualizer_Points,struct __pyx_t_10visualizer_Points>  __pyx_r;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("bb_dimensions", 0);

  /* "GlimpseVisualizer.pyx":98
 ...
 *         if (w < 1): w = 1
 */
  __pyx_t_2 = ((__pyx_v_w > __pyx_v_clip) != 0);
  if (__pyx_t_2) {
    __pyx_v_w = __pyx_v_clip;
  }

  /* "GlimpseVisualizer.pyx":102
 * 
 *         if (w > clip): w = clip
 *         if (h > clip): h = clip             # <<<<<<<<<<<<<<
 *         if (w < 1): w = 1
 *         if (h < 1): h = 1
 */
  __pyx_t_2 = ((__pyx_v_h > __pyx_v_clip) != 0);
  if (__pyx_t_2) {
    __pyx_v_h = __pyx_v_clip;
  }

  /* "GlimpseVisualizer.pyx":103
 *         if (w > clip): w = clip
 *         if (h > clip): h = clip
 *         if (w < 1): w = 1             # <<<<<<<<<<<<<<
 *         if (h < 1): h = 1
 ...
 *         limit_1.start = y
 */
  __pyx_t_2 = (((__pyx_v_x + __pyx_v_w) > 0x64) != 0);
  if (__pyx_t_2) {
    __pyx_v_w = (99 - __pyx_v_x);
  }

  /* "GlimpseVisualizer.pyx":111
 *         if (y<0): y = 0
 *         if (x+w>100): w = 99-x
 *         if (y+h>100): h = 99-y             # <<<<<<<<<<<<<<
 *         limit_1.start = y
 *         limit_1.end = y+h
 */
  __pyx_t_2 = (((__pyx_v_y + __pyx_v_h) > 0x64) != 0);
  if (__pyx_t_2) {
    __pyx_v_h = (99 - __pyx_v_y);
  }

  /* "GlimpseVisualizer.pyx":112
 *         if (x+w>100): w = 99-x
 *         if (y+h>100): h = 99-y
 *         limit_1.start = y             # <<<<<<<<<<<<<<
 *         limit_1.end = y+h
...
static void __pyx_f_10visualizer_11GVisualizer_create_heatmaps(struct __pyx_obj_10visualizer_GVisualizer *__pyx_v_self, __Pyx_memviewslice __pyx_v_labels, __Pyx_memviewslice __pyx_v_positions) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("create_heatmaps", 0);

  /* "GlimpseVisualizer.pyx":132
 *             pair[Points, Points] dimensions
 *             double[:] bb_o
 ...
 *             h=0
 */
  __pyx_t_1 = __pyx_v_self->dim2;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "GlimpseVisualizer.pyx":135
 * 
 *         for i in range(self.dim2): # ACHTUNG NUR EIN EINZIGES BILD WIRD ITERIERT
 *             w=0             # <<<<<<<<<<<<<<
 *             h=0
 ...
 */
          ...
          *((__pyx_t_10visualizer_uchar *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_output.data + __pyx_t_20 * __pyx_v_output.strides[0]) ) + __pyx_t_21 * __pyx_v_output.strides[1]) ) + __pyx_t_22 * __pyx_v_output.strides[2]) ) + __pyx_t_23 * __pyx_v_output.strides[3]) )) = ((((__pyx_v_self->heat_maps[__pyx_v_i])[__pyx_v_j])[__pyx_v_k])[__pyx_v_n]);
        }
      }
    }
  }
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "visualizer._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_visualizer(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_visualizer},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initvisualizer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initvisualizer(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_visualizer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_visualizer(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_visualizer(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'visualizer' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_visualizer(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("visualizer", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_visualizer) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "visualizer")) {
      if (unlikely(PyDict_SetItemString(modules, "visualizer", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init visualizer", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init visualizer");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsdsdsds_nn___pyx_t_10visualizer_uchar(PyObject *obj, int writable_flag) {
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 ...
                                                 &__Pyx_TypeInfo_nn___pyx_t_10visualizer_uchar, stack,
                                                 &result, obj);
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_10visualizer_uchar(PyObject *obj, int writable_flag) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
